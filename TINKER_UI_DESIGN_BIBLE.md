...
- **Symptom:** FRACTAL REFLECTION system prompts appeared as blue user chat bubbles in Tinker UI, making it look like Oscar had sent a multi-paragraph system message.
...
| ------------------ | --------------------- | -------------- | ------------------------------------------- |
| Oscar (self-chat)  | Message yourself      | No             | Always triggers                             |
| Oscar (fromMe)     | Exempt group          | No             | Always triggers                             |
| Oscar (fromMe)     | Any other DM or group | "jarvis ..."   | Triggers                                    |
| Oscar (fromMe)     | Anywhere, no prefix   | —              | Ignored                                     |
