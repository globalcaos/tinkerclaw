 ...
 *
 * the user, on the 2026-07-31 gateway restart: "I can see now a thinking indicator
 ...
 * the user: "I am not against the thinking indicator informing about the internal state
