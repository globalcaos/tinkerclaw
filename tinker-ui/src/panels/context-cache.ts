// FORK 2026-07-25 (the user): "Context Cache" — the right-rail panel that answers two questions
...
//
// FORK 2026-08-28 (the user): renamed "CONTEXT WINDOW" in the UI, and the window bar is now drawn
...
/**
 * FORK 2026-08-29 (the user: switching opus -> grok left the window outline unchanged; "it should
 * have gone white").
 *
...
export interface CachePanelState {
  ...
  // FORK 2026-08-29 (the user: "we will have a section called 'this call' and another named 'this
...
/**
 * FORK 2026-08-28 (the user: "we should visualize the colorful graph of a 1M token window, which I
...
export function renderCachePanelHtml(s: CachePanelState): string {
  ...
  // FORK 2026-08-28 (the user: "an empty rectangle on top of the graph, in the color of the
  ...
  // FORK 2026-08-28 (the user: "if the present context exceeds the window that we want to use, it
  ...
  // UNBOUNDED (the user: "it does not make sense to represent in a graph an unbounded value"): a
