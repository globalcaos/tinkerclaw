...
describe("smart-model dossier — coverage", () => {
  ...
  // The correction the user caught 2026-08-06: the first version claimed both camps
...
// FORK 2026-08-15 (the user): the CN provider × model price matrix at the foot of the
...
// FORK 2026-09-02 (the user): "mark in the dossier table the best at each category, and
