...
describe("MODEL section — the choice, not the rule", () => {
  it("a fixed model is stated and nothing more (the user: no unnecessary words)", () => {
...
describe("FAN-OUT section", () => {
  ...
  it("lists every routing call made during the turn", () => {
    ...
    // ONE LINE, always (the user 2026-07-29: "Fan-out should only be one line") — the same
  ...
  // REGRESSION 2026-07-27 (the user: "the orca panel is like a kilometer long"): the Conductor
