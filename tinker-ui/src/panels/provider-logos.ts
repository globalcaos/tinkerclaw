...
// FORK 2026-08-04 (the user: "Copilot still has the blue logo, change it for its
...
export const PROVIDER_LOGO_SVG: Record<string, string> = {
  ...
  // FORK 2026-08-28 (the user: chart ChatGPT bubbles used a white "AI" disc).
  ...
  // FORK 2026-07-21 (the user): Grok/xAI "planet with one ring" mark (white on dark).
...
// FORK 2026-07-22 (the user): codex / openai-codex (gpt-5.5/5.6 on the ChatGPT sub)
// = OpenAI mark.
...
// FORK 2026-09-04 (the user: "Openrouter has the wrong logo, do they have a specific one?").
...
// the user, on a Claude turn: "why is there an OpenRouter icon there?". There was not.
...
// FORK 2026-08-30 (the user: "openrouter bubbles have the wrong icon"). This function
...
// FORK 2026-08-04 (the user): the OpenRouter vendors (Kimi, Qwen, GLM, DeepSeek) all
