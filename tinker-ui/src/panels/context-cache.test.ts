...
// FORK 2026-08-28 (the user): the fixed 1M ruler, the provider-coloured window outline, the red
...
describe("model window outline", () => {
  ...
  // FORK 2026-08-29 (the user: "when I switch from opus to grok ... it should have gone white and
...
// FORK 2026-08-29 (the user): THIS CALL and THIS SESSION are panels of numbers, not bars —
