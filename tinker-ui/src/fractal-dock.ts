...
// FORK 2026-08-11 (the user) — LEVEL 3: the triage lane's OWN transcript, nested.
...
// EXPORTED 2026-08-11 (the user: "I cannot see the extra expansion button once I expand
...
export function renderFractalDock(
  ...
  summary.textContent =
    // FORK 2026-08-11 (the user: "You should only have one thing called fractal, the other
    ...
    //
    // FORK 2026-08-23 (the user: "Triage should be renamed Fractal instead") — REVERSED. Both
    ...
    //
    // FORK 2026-08-23, second pass (the user: "we use adjectives to nouns to disambiguate ... the
