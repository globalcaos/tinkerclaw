// FORK 2026-08-18 — feature (the user): "If a process is attached to a tab and it prevents me to send
...
/**
 * Human age for one row. Three bands, matching the mock the user approved:
