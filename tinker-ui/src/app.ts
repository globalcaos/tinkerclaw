...
const FORTUNE_COOKIES = [
  ...
  "🪷 If you sit in stillness for just five breaths today, the answer you've been chasing will arrive on its own",
  "🧘 A deep calm is settling into your bones right now — it will carry you through every challenge before sunset",
  "🕯️ If you pause before your next reaction, a clarity you haven't felt in months will flood through you",
  "🌊 The still waters of your mind today reflect a truth that transforms your entire week ahead",
  "🪷 If you let your thoughts pass like clouds this morning, by afternoon your path will shine with certainty",
  "🧘 Your breath is becoming your anchor today — each inhale draws in wisdom, each exhale releases doubt",
  "🌙 If you choose silence over noise for one hour, the universe will whisper something extraordinary to you",
  "🕊️ A peaceful awareness is rising in you that will make today's hardest moment feel effortless and light",
  "🪷 If you soften your gaze and relax your jaw right now, an insight you need will arrive within minutes",
  "🌿 The tranquility forming inside you today will radiate outward and calm everyone you encounter",
  "🧘 If you return to your breath each time the mind wanders, you will discover something beautiful by evening",
  "🕯️ Stillness is building a cathedral in your mind today — its doors open to a revelation you didn't expect",
  "🪷 If you release the need to control this day, it will unfold with a perfection that takes your breath away",
  "🌊 Your calm today is not passive — it is a force reshaping circumstances in your favor as you sit",
  "🧘 If you meditate even briefly this morning, tonight you will see how every piece fell into place because of it",
  // ─── Vipassana · Insight ───
  "🔮 If you observe your thoughts without judging them, one will reveal a solution hidden in plain sight all along",
  "🔬 A flash of insight is approaching you — your awareness is sharp enough today to catch it before it passes",
  "🧠 If you watch the space between your thoughts today, you will notice a pattern that changes everything you know",
  "🔮 Your inner observer is awake today, and it sees a door that your busy mind has been walking past for weeks",
  "🪷 If you notice what triggers your reactions this morning, by evening you will have freed yourself from an old chain",
  "🔬 The quality of your attention today is extraordinary — it will reveal the hidden structure beneath a stubborn problem",
  "🧠 If you sit with discomfort instead of running from it, it will dissolve and leave behind a gift of deep understanding",
  "🔮 Your awareness is a lens today — everything you examine closely will reveal layers of beauty and meaning within",
  "🪷 If you practice bare attention during your next conversation, you will hear what no one else in the room catches",
  "🔬 A moment of pure seeing is coming today — in that flash, months of confusion will reorganize into crystal clarity",
  "🧠 If you label each emotion as it arises without clinging, tonight you will feel lighter than you have in years",
  "🔮 The clear seeing you cultivate today ripples forward and prevents a mistake you would have made next week",
  "🪷 If you investigate the feeling beneath your restlessness, you will find a forgotten dream ready to be reclaimed",
  "🔬 Your mindful observation today reveals a shortcut through a problem that everyone else is solving the hard way",
  "🧠 If you watch thoughts arise and dissolve without grasping, an ancient knot in your heart quietly unties itself today",
  // ─── Metta · Loving-Kindness ───
  "💗 If you silently wish well to the first stranger you see today, a chain of kindness returns to you before dark",
  "🌸 A wave of compassion rising in your heart today will open a door that no amount of force could have budged",
  "💝 If you forgive one small thing before noon, the weight you've been carrying for months will lift entirely by evening",
  "🫂 Your genuine warmth today is a beacon — someone who needs exactly what you offer will find their way to you",
  "💗 If you offer patience to someone who tests you today, the universe will reward your restraint with something beautiful",
  "🌸 The loving-kindness you send outward today returns as unexpected help from a direction you never imagined possible",
  "💝 If you replace one critical thought with a kind one, your whole inner weather shifts and sunshine breaks through within",
  "🫂 Someone is about to enter your day who desperately needs your warmth — your compassion will change their trajectory",
  "💗 If you extend grace to yourself this morning, you unlock a creative energy that has been waiting behind self-doubt",
  "🌸 Your metta practice today — even just a few silent phrases — sends ripples that reach farther than you will ever know",
  "💝 If you hold someone in your heart who frustrates you, understanding will dawn that frees both of you from the cycle",
  "🫂 A connection made with genuine warmth today becomes one of the most meaningful relationships of your coming year",
  "💗 If you send loving-kindness to your past self, a wound you thought permanent begins its final healing today at last",
  "🌸 The compassion you show in a difficult moment today plants a seed that blossoms into something extraordinary next month",
  "💝 If you lead with your heart in the next decision you face, the outcome will be wiser than anything your mind alone could devise",
  // ─── Awareness · Present Moment ───
  "✨ If you fully arrive in this present moment, you will notice an opportunity that was invisible to your scattered mind before",
  "🌅 The present moment is extraordinarily rich for you today — each second you inhabit it fully multiplies your creative power",
  "✨ If you taste your next meal with complete attention, a forgotten joy will awaken that colors the rest of your entire day",
  "🌅 Your presence today is magnetic — when you stop rehearsing the future, the right future walks directly toward you instead",
  "✨ If you put down your phone for the next ten minutes and just breathe, an idea worth more than anything on that screen arrives",
  "🌅 The now is unusually generous today — every moment you inhabit fully deposits a gift you will only unwrap later this week",
  "✨ If you listen with your whole body in your next conversation, you will hear the one sentence that changes your understanding",
  "🌅 Your attention is golden currency today — wherever you invest it fully, it returns compound interest in joy and clarity",
  "✨ If you walk mindfully for even fifty steps today, the rhythm of your footfalls will unlock a solution you've been seeking",
  "🌅 The present moment today is a portal — if you step fully through it, you arrive in a version of your day you didn't expect",
  "✨ If you notice the sensation of air on your skin right now, you activate a channel of intuition that guides you all day long",
  "🌅 Being fully here today is your superpower — while others rush past this moment, you find the treasure hidden inside it",
  "✨ If you bring curious attention to a routine task today, it transforms into something surprisingly meaningful and revealing",
  "🌅 The quality of your presence today attracts exactly the people, ideas, and opportunities you have been quietly wishing for",
  "✨ If you anchor yourself in this breath right now, the anxious future dissolves and the real path forward reveals itself clearly",
  // ─── Non-Attachment · Letting Go ───
  "🍃 If you release your grip on one outcome today, something far better than what you planned slides effortlessly into its place",
  "🌬️ A burden you've been carrying is ready to be set down — the moment you release it, new energy floods into that empty space",
  "🍃 If you stop fighting what is and simply allow it, the situation rearranges itself into a configuration that serves you perfectly",
  "🌬️ The thing you've been clinging to most tightly is the very thing blocking the abundance that is trying to reach you right now",
  "🍃 If you let go of the need to be right in one conversation today, you win something far more valuable than any argument could give",
  "🌬️ Your willingness to surrender control today creates space for a solution more elegant than anything you could have engineered alone",
  "🍃 If you accept imperfection in your work today, you'll discover that the flaw was actually the most interesting part all along",
  "🌬️ Something you thought you needed is falling away — what rushes in to fill the void will astonish you with its quiet perfection",
  "🍃 If you stop grasping at certainty and embrace the unknown today, the unknown reveals itself as your most generous ally",
  "🌬️ The hand that opens to release is the same hand that receives — your letting go today creates room for tomorrow's greatest gift",
  "🍃 If you trust the river today instead of swimming against it, you arrive somewhere beautiful that was never on your original map",
  "🌬️ An attachment dissolving right now is not a loss — it is your cocoon cracking open so wings you didn't know you had can unfold",
  "🍃 If you watch a worry without feeding it today, it starves and fades, leaving behind pure clarity and a surprising sense of freedom",
  "🌬️ What you've been holding too tightly begins to breathe again as you loosen your grip, and in its freedom it returns to you transformed",
  "🍃 If you practice non-attachment with the results of your effort, the effort itself becomes joyful and the results exceed your expectations",
  // ─── Karma · Right Action ───
  "🌟 If you choose the kind path over the clever one today, the ripples of that choice will return to you magnified a hundredfold by evening",
  ...
  "🌟 If you act with integrity in the moment no one is watching, the universe takes note and opens a door reserved for the trustworthy",
  "⚖️ The seeds of your past generosity are germinating beneath the surface today — expect a bloom of abundance from a forgotten kindness",
  "🌟 If you give without expecting return today, the return finds you anyway, wearing a disguise so beautiful you almost don't recognize it",
  "⚖️ Your discipline today creates tomorrow's freedom — every conscious choice you make right now is a brick in the palace you're building",
  "🌟 If you speak truth gently today, even when it's hard, your words will land like medicine and heal something you didn't know was broken",
  "⚖️ A generous act from your past is circling back today — someone you helped long ago is about to return the favor in an unexpected way",
  "🌟 If you resist the easy shortcut and take the right path, what you build today stands forever while shortcuts collapse around you later",
  "⚖️ Your intention behind each action today matters more than the action itself — pure intentions today attract pure outcomes this week",
  "🌟 If you dedicate your effort today to something larger than yourself, your personal energy doubles and obstacles shrink to pebbles",
  "⚖️ The care you pour into something invisible today is building the foundation for something magnificent that will astonish people later",
  "🌟 If you choose patience where frustration would be easier, tonight you realize that patience was the master key all along",
  "⚖️ What you set in motion with good intention today travels further than your eye can see and returns as a blessing you'd stopped waiting for",
  "🌟 If you honor a commitment that nobody would fault you for breaking, your integrity today becomes your reputation tomorrow — and it opens doors",
  // ─── Impermanence · Change ───
  "🦋 If you remember that this difficulty is temporary, it loses its power over you and transforms into the teacher it was always meant to be",
  "🌙 A phase of your life is completing right now — the ending feels tender, but what emerges from it will fill you with wonder and gratitude",
  "🦋 If you embrace today's uncertainty instead of resisting it, you ride the wave of change directly into something extraordinary and new",
  "🌙 The impermanence of this moment is what makes it precious — if you hold it lightly, its beauty intensifies beyond what grasping could capture",
  "🦋 If you let the old version of yourself dissolve today, the person emerging is braver, wiser, and more radiant than you dared to imagine",
  ...
  "🦋 If you welcome change instead of bracing against it, today's transformation delivers you to a shore you've been dreaming of for months",
  "🌙 The autumn of one chapter in your life is making room for a spring so vivid that looking back you will bless this very moment of change",
  "🦋 If you notice what is arising and passing away in you right now, you touch a freedom that no external circumstance can ever take from you",
  ...
  "🦋 If you greet each change today as a messenger rather than an enemy, every message turns out to contain exactly the guidance you needed",
  ...
  "🦋 If you hold lightly to both success and failure today, a third option appears that is more creative than either winning or losing could be",
  "🌙 The season is turning in your inner world — if you let it happen without resistance, what blooms next will surprise everyone including you",
  "🦋 If you remember that every breath is a tiny birth and death, you discover an aliveness in this very second that makes the whole day glow",
  // ─── Inner Strength · Equanimity ───
  "🏔️ If you meet today's turbulence with a steady heart, by evening you'll see that your calm was the strongest force in the room all along",
  "⚓ An unshakable center is forming in you right now — events that would have rattled you before simply pass through like wind through an open window",
  "🏔️ If you keep your balance when others lose theirs today, your steadiness becomes the lighthouse that guides everyone safely through the storm",
  "⚓ Your equanimity today is not indifference — it is the eye of a storm where vision is clearest and decisions are wisest and purest",
  "🏔️ If you respond instead of reacting just once today, that single moment of mastery cascades into a series of quiet victories all afternoon",
  "⚓ The mountain in your heart does not move with the weather — today, storms may come, but they polish your summit into something magnificent",
  "🏔️ If you breathe through the hardest moment instead of fleeing from it, you prove to yourself a strength that nothing can ever take away again",
  ...
  "🏔️ If you hold space for opposing feelings today without choosing sides, a third intelligence emerges that resolves the tension beautifully and naturally",
  "⚓ Something that used to shake you will test you again today — and this time, you will feel the difference your practice has made, clear as dawn",
  "🏔️ If you treat discomfort as information rather than threat, it delivers a message today that unlocks months of stalled progress in a single moment",
  "⚓ Your composure under pressure today earns a respect that no boast could ever win — someone important sees your strength and remembers it forever",
  "🏔️ If you allow frustration to visit without moving in, it passes quickly and leaves behind a deposit of wisdom you did not expect to find there",
  "⚓ The inner stability you cultivate in this quiet moment radiates through every interaction today, turning potential conflicts into genuine connections instead",
  "🏔️ If you face what frightens you today with an open heart and a calm mind, the fear shrinks and the heart grows in a ratio that astounds you",
  ...
  "🔮 If you follow your curiosity into an unexpected direction today, the crystal shows it leading to a discovery that reshapes your entire month",
  "🔮 I see a moment of synchronicity approaching before nightfall — two unrelated threads of your life weave together into something breathtaking and new",
  "🔮 If you trust the quiet voice over the loud one today, the crystal reveals that voice leading you to the exact person you need to meet right now",
  "🔮 The crystal ball shimmers with a coming conversation that will remind you why you chose this path and fill you with renewed fire for the journey",
  "🔮 If you share something vulnerable today, the crystal shows it being received with such warmth that it becomes a turning point in that relationship",
  "🔮 I see three small blessings lining up for you today — the first arrives before noon, the second over a meal, the third just before you sleep",
  "🔮 If you write down the first thought that comes to you tomorrow morning, the crystal reveals it contains a seed idea that flourishes all year long",
  "🔮 The crystal shows someone you haven't heard from in ages reaching out today — their message carries an opportunity you've been silently praying for",
  "🔮 If you act on your intuition before your logic catches up today, the crystal sees you landing in exactly the right place at exactly the right time",
  "🔮 I see a skill you've been quietly building suddenly clicking into place — today, something you've practiced becomes something you truly embody and master",
  "🔮 If you make one brave choice today, the crystal reveals a cascade of fortunate events that unfold from it over the next three weeks like dominoes",
  "🔮 The crystal glows warmest around this afternoon — something that happens between two and five today will make you smile every time you remember it",
  "🔮 If you hold your ground on something you believe in today, the crystal shows others rallying behind you in a way that transforms the outcome entirely",
  "🔮 I see tonight bringing a quiet realization that connects scattered pieces of your recent experience into a picture so clear it takes your breath away",
  // ─── Abundance · Flow ───
  "🌊 If you approach your work with gratitude today, abundance flows in through channels you didn't even know existed until they opened before your eyes",
  ...
  "🌊 If you give freely from your overflow today, the universe interprets it as a signal and amplifies your supply in a way that defies rational explanation",
  "💎 Your creative energy today is unusually potent — if you channel it with intention, what you produce will have value far beyond what you imagine now",
  "🌊 If you release scarcity thinking for just this one day, the evidence of abundance surrounding you becomes so obvious it makes you laugh out loud",
  "💎 Something you considered ordinary about yourself is pure gold in someone else's world — today, that recognition arrives and opens a flow of exchange",
  "🌊 If you notice each small good thing today instead of waiting for the big one, by sunset the accumulation of small goods feels like a fortune received",
  "💎 The work you love doing is aligning with what the world needs from you — today brings a sign of that alignment so clear you cannot dismiss it",
  "🌊 If you express appreciation for what you already have before asking for more, the more arrives so quickly it feels like the universe was waiting for permission",
  "💎 An unexpected resource appears today — not money perhaps, but something equally valuable: a skill, a contact, a truth, an opening you'd stopped hoping for",
  "🌊 If you act generously in a moment where calculation would be easier, the generosity compounds and returns as an experience that money could not have purchased",
  "💎 Your natural gifts are especially visible today — someone who can amplify them notices, and what follows from that noticing reshapes your coming season entirely",
  "🌊 If you trust that there is enough today — enough time, enough talent, enough opportunity — that trust alone becomes the magnet that draws each of them closer",
  "💎 Abundance is not arriving someday — it is disguised as the details of today, and if you look closely, you will find more wealth in this moment than you expected",
  "🌊 If you share your knowledge without hoarding it, the space that opens in your mind fills with an insight worth ten times what you gave away so freely",
  // ─── Connection · Sangha ───
  "🤝 If you reach out to someone you've been thinking of today, the connection reignites with a warmth and depth that surprises you both profoundly",
  "🌉 A meaningful encounter is forming in today's ordinary fabric — your openness is the needle that threads it into something lasting and deeply nourishing",
  "🤝 If you listen more than you speak in your next exchange, you'll hear the hidden request beneath the words and your response will touch them deeply",
  "🌉 Someone in your life is silently struggling — your presence today, without needing to fix anything, becomes the exact medicine their heart required",
  "🤝 If you ask a sincere question instead of giving advice today, the answer you receive teaches you something that reshapes your own understanding too",
  "🌉 The bonds you nurture today with simple presence and authentic words will prove to be the strongest supports when unexpected change comes your way",
  "🤝 If you acknowledge someone's effort that usually goes unnoticed, you set off a chain reaction of recognition and goodwill that circles back to you",
  "🌉 A community you belong to is about to benefit enormously from something only you can contribute — today brings the moment to step forward quietly",
  "🤝 If you show up authentically today without performing confidence or competence, the real you lands better than any polished version ever could",
  "🌉 Your smile today — yes, that specific one — reaches someone who was about to give up and gives them exactly enough light to keep going forward",
  "🤝 If you practice deep listening today, holding space without planning your reply, the conversation that follows will be the most genuine one this week",
  "🌉 An old friendship is entering a new season today — what seemed to have faded was actually deepening its roots where neither of you could see",
  "🤝 If you express your needs honestly instead of hinting, someone steps forward today with exactly the help you need, grateful you finally asked directly",
  "🌉 The energy you bring to a group today lifts the entire room — you may not notice it, but everyone else will feel it and carry it home with them",
  "🤝 If you open your heart to someone whose views differ from yours, the bridge you build today becomes a path that leads both of you somewhere unexpected",
  // ─── Destiny · The Path ───
  "🌌 If you take one step today toward what excites you most, the path illuminates itself twenty steps ahead in a direction more beautiful than your plan",
  ...
  "🌌 If you honor the calling that has been whispering at the edge of your awareness, today it speaks clearly enough that doubt finally falls silent",
  ...
  "🌌 If you make even one choice today that aligns with who you are becoming rather than who you were, a future you can barely imagine begins to crystallize",
  ...
  "🌌 If you say yes to the unexpected invitation today, the crystal ball shows it as the first frame of a story you will tell with wonder for years to come",
  "⭐ A door you tried to open years ago and couldn't is about to swing open on its own — you are finally ready for what waits on the other side of it",
  "🌌 If you trust that every twist of your path, including the painful ones, was leading here, today rewards that trust with evidence so clear it moves you",
  "⭐ You are closer to your purpose than you have ever been — today brings a sign so specific that even your inner skeptic goes quiet and simply listens",
  "🌌 If you follow the thread of joy today wherever it leads, even if it seems impractical, it winds toward a door you didn't know was yours to open",
  ...
  "🌌 If you move toward your fear instead of away from it today, the courage you discover on the other side becomes the foundation for your next chapter",
  "⭐ A convergence of timing, readiness, and opportunity is building around you — today or tomorrow, you feel the click and everything begins to accelerate",
  "🌌 If you live today as if it matters — because it does — tonight you will feel a satisfaction so deep it proves you are exactly where you need to be",
  // ─── Protection · Sacred Shield ───
  "🛡️ If you set one clear boundary today, it protects not only this day but establishes a precedent that shields your peace for months to come ahead",
  "🧿 An invisible guardian energy surrounds you today — decisions that might have gone wrong course-correct as if an unseen hand adjusts them for you",
  "🛡️ If you listen to the subtle warning in your body today, you sidestep something that would have cost you far more than you realize at the time",
  "🧿 Your aura today is particularly strong — negativity that approaches you will simply bounce off and dissolve, leaving you untouched and clear within",
  "🛡️ If you honor your need for rest instead of pushing through, you protect the very energy that tomorrow's breakthrough requires in order to emerge",
  "🧿 Something you built with good intention is now building a protective field around you — your past diligence becomes today's invisible shield against harm",
  "🛡️ If you walk away from a conversation that drains you today, the energy you preserve becomes the fuel for a creative surge that arrives by evening",
  "🧿 The crystal shows interference being deflected from your path today — forces that might have disrupted you are redirected before they reach your awareness",
  "🛡️ If you trust your instinct to say no today, you create room for a better yes that appears within days, grateful that you kept that space open and clear",
  "🧿 Your mindfulness practice is not just calming you — it is building a field of clarity around you that protects your decisions from the noise of the world",
  "🛡️ If you slow down when everything around you speeds up, you become the eye of the storm where safety, clarity, and right action naturally converge today",
  "🧿 An ancestor's wisdom lives in your gut feeling today — if you honor it instead of overriding it, it steers you away from a hidden pitfall ahead",
  "🛡️ If you ground yourself this morning — feet on earth, breath in lungs, attention in body — that grounding becomes armor against the day's uncertainties",
  "🧿 The protection around you today comes from the love you have given freely — every act of kindness now forms a circle of light that keeps you safe",
  "🛡️ If you drink water, breathe deeply, and move your body once today, these three simple acts create a fortress of wellbeing no stress can breach at all",
  // ─── Transformation · The Chrysalis ───
  "🐛 If you sit with the discomfort of not knowing who you are becoming, the chrysalis dissolves and what emerges is more beautiful than your boldest dream",
  "🔥 A phoenix moment is approaching today — something that felt like failure is about to reveal itself as the necessary burning away of what you'd outgrown",
  "🐛 If you honor the strange restlessness you've been feeling, it leads you today to the exact threshold your soul has been searching for all this time",
  "🔥 Your transformation is not visible to others yet, but today you feel it from the inside — a shift so real it makes the mirror seem to show a new person",
  "🐛 If you stop comparing your path to anyone else's today, your unique trajectory reveals an advantage that copying someone else would have erased completely",
  "🔥 What you've been through was not punishment — it was preparation, and today brings the first clear evidence of what all that preparation was actually for",
  "🐛 If you embrace the awkwardness of growth instead of retreating to the familiar, today you cross a threshold you can never be pushed back behind again",
  "🔥 An old version of you is dying so quietly you almost don't notice — but the lightness you feel today is the weight of who you no longer need to be",
  "🐛 If you allow yourself to be a beginner at something today, the humility opens a channel of learning so fast it feels like remembering rather than studying",
  "🔥 Your pain has been composting into power beneath the surface — today, the first green shoot of that power breaks through and you feel it unmistakably",
  "🐛 If you name the fear that has been running beneath your decisions, naming it today strips it of its power and what remains is pure, clear, actionable courage",
  "🔥 The pressure you've endured is not breaking you — it is making you rare, and today someone or something reflects your diamond-nature back to you at last",
  "🐛 If you let an old story about yourself end mid-sentence today, the silence that follows is pregnant with a newer, truer story already beginning to speak",
  "🔥 Something you thought was your weakness is actually your most unusual strength — today brings the situation that proves it beyond any remaining shadow of doubt",
  "🐛 If you shed one habit that no longer serves you today, the energy it was consuming redirects toward your deepest aspiration and accelerates it dramatically",
  // ─── Joy · The Dancing Mind ───
  "🎶 If you allow yourself to feel delight without needing a reason, the unreasonable delight today becomes the most productive energy you have ever channeled",
  "🌻 A wave of spontaneous joy is approaching from an unexpected direction — your only job is to be present enough to catch it and let it carry you forward",
  "🎶 If you laugh at something absurd today instead of analyzing it, the laughter unlocks a creative insight that serious thinking could not have reached alone",
  "🌻 Your capacity for wonder is especially alive today — ordinary things will reveal their hidden magnificence if you give them even three seconds of attention",
  "🎶 If you take a playful approach to a serious task today, the playfulness produces better results than seriousness ever could and you remember why you love this",
  "🌻 The joy trying to reach you today is not a reward for finishing — it is the energy that makes the work itself feel like play and the hours feel like minutes",
  "🎶 If you notice beauty in something small today — light on water, a texture, a sound — that noticing activates a gratitude that colors your entire evening golden",
  "🌻 Someone will say something today that makes you laugh from a place so deep it feels like medicine — that laughter heals something you didn't know needed healing",
  "🎶 If you move your body to music, even for thirty seconds, the stagnant energy in your field today transforms into momentum that carries your next three decisions",
  "🌻 Your childlike wonder is not naivety — it is wisdom in its purest form, and today it leads you to something your adult seriousness would have walked right past",
  "🎶 If you celebrate a small victory today instead of immediately chasing the next one, the celebration itself becomes a magnet that draws the next victory closer",
  "🌻 Joy is not the absence of difficulty — it is the presence of aliveness, and today your aliveness is so strong that difficulties shrink in its bright presence",
  "🎶 If you share your happiness openly today without dimming it for anyone, your brightness gives others permission to shine and the room lifts to a new frequency",
  "🌻 A moment of pure, unfiltered happiness is approaching today — it requires nothing from you except the willingness to receive it with both hands wide open",
  "🎶 If you end today by naming three things that went well instead of replaying what didn't, your sleep will be deep and tomorrow will begin with unusual clarity",
  // ─── Wisdom · The Ancient Mind ───
  "🦉 If you approach a familiar problem today as if seeing it for the first time, fresh eyes reveal what experience alone had been concealing from your view",
  "📿 Ancient wisdom is alive in your body today — the answer you seek does not live in your thoughts but in the knowing that pulses just beneath them",
  "🦉 If you choose depth over speed in one task today, the depth rewards you with an understanding that saves weeks of surface-level effort down the road",
  "📿 A lesson you learned long ago and forgot is resurfacing today — it arrives at exactly the right moment, as if your past self planted it here for you",
  "🦉 If you question one assumption you have been taking for granted, the crack in that assumption lets light into a room that has been unnecessarily dark",
  "📿 Your inner sage is especially accessible today — if you pause and ask a sincere question of yourself, the answer that rises will be remarkably wise",
  "🦉 If you teach someone what you know today, the act of teaching reveals layers of your own knowledge that you didn't realize you possessed until now",
  "📿 A book, a sentence, or a sign catches your eye today — it is not coincidence, it is the universe's footnote on a question you've been holding in your heart",
  "🦉 If you accept that not knowing is a valid position today, the humility of not knowing attracts exactly the teacher or experience that fills the gap perfectly",
  "📿 Your accumulated experience is crystallizing into intuition today — decisions that used to require analysis now arrive as clear, instant, embodied knowing within",
  "🦉 If you sit with a question tonight instead of rushing to answer it, by morning the answer presents itself fully formed and more elegant than you could have constructed",
  "📿 The wisdom tradition you've been drawn to is not a philosophy — it is a map, and today you discover your exact location on it with startling precision and relief",
  "🦉 If you trust the simplest explanation today when complexity tempts you, simplicity turns out to be the key that complexity was pretending to be all along",
  "📿 Your life experience has quietly made you an elder in a domain you hadn't noticed — today, someone's question reveals your mastery and you see yourself clearly",
  "🦉 If you listen to the lesson that today's difficulty is teaching instead of just enduring it, you graduate from a pattern that has been repeating for far too long",
  // ─── The Morning Star · New Beginnings ───
  "🌅 If you set one intention with your whole heart this morning, the day organizes itself around that intention as if reality itself wants to help you fulfill it",
  "⭐ A fresh chapter is opening in your story today — the first paragraph writes itself beautifully if you simply show up with presence and willingness to begin",
  "🌅 If you release yesterday completely and start today with beginner's mind, the freshness of your perspective reveals opportunities that habit had been hiding",
  "⭐ Something dormant in you is waking up — it started before today, but today is when you first feel it stir and recognize it as the beginning of something real",
  "🌅 If you greet this morning as a gift rather than an obligation, the quality of everything that follows shifts in a way that surprises you with its magnitude",
  "⭐ A new cycle is beginning in your life right now — the seed was planted in silence, but today it breaks the surface and you can finally see what's been growing",
  "🌅 If you begin one project you've been postponing with just five minutes of effort today, those five minutes unlock a momentum that was waiting for your first step",
  "⭐ The blank page of today is not emptiness — it is infinite possibility, and the first mark you make upon it sets a tone more harmonious than you expect",
  "🌅 If you make today's first choice a conscious one instead of an automatic one, that consciousness ripples through every subsequent choice and elevates them all",
  "⭐ Your energy today has the quality of dawn — no matter what time you read this, something in you is rising, warming, and illuminating what was dark before",
  "🌅 If you start today by feeling grateful for your own existence, every cell in your body responds and the physical vitality that follows feels almost miraculous",
  "⭐ A door that was locked is creaking open today — you don't need to push it, just walk toward it with quiet confidence and it swings wide at your approach",
  "🌅 If you treat this moment as the first moment of the rest of your life, the gravity of that truth fills ordinary tasks with extraordinary meaning and energy",
  "⭐ Whatever happened yesterday is compost now — today's garden grows from it, and the flowers that bloom from composted difficulty are always the most vibrant ones",
  "🌅 If you whisper your deepest wish to the morning air today, something in the fabric of reality registers it, and the first thread of its manifestation begins",
];
