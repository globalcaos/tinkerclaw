...
const FORTUNE_COOKIES = [
  ...
  "⚖️ Seeds of your past generosity are germinating beneath the surface today — expect a bloom of abundance from a forgotten kindness",
  ...
  "⚖️ A generous act from your past is circling back right now — someone you helped long ago is about to return the favor unexpectedly",
  ...
  "⚖️ Honor a commitment nobody would fault you for breaking, and your integrity today becomes your reputation tomorrow — opening doors",
  // ─── Impermanence · Change ───
  ...
  "🏔️ Respond instead of reacting just once today: that single moment of mastery cascades into a series of quiet victories all afternoon",
  ...
  "🏔️ Breathe through the hardest moment instead of fleeing from it, and you prove to yourself a strength that nothing can ever take away",
  ...
  "⚓ Something that used to shake you tests you again today — and this time, you feel the difference your practice has made, clear as dawn",
  ...
  "🔮 I see a moment of synchronicity approaching before nightfall — two unrelated threads of your life are about to weave into something breathtaking",
  ...
  "🔮 The crystal ball shimmers with a coming conversation that will remind you why you chose this path and fill you with renewed fire",
  ...
  "🔮 The crystal glows warmest around this afternoon — something between two and five today will make you smile every time you remember it",
  ...
  "💎 An unexpected resource appears today — not money perhaps, but something equally valuable: a skill, a contact, a truth you'd stopped hoping for",
  ...
  "🤝 Acknowledge someone's effort that usually goes unnoticed and you set off a chain reaction of goodwill that circles all the way back to you",
  ...
  "🤝 Express your needs honestly instead of hinting, and someone steps forward today with exactly the help you need, grateful you finally asked",
  // ─── Destiny · The Path ───
  ...
  "⭐ A door you tried to open years ago is about to swing open on its own — you are finally ready for what waits on the other side of it",
  "🌌 Trust that every twist of your path, including the painful ones, was leading here — today rewards that trust with evidence so clear it moves you",
  ...
  "🛡️ Listen to the subtle warning in your body today and you sidestep something that would have cost you far more than you realize at the time",
  ...
  "🛡️ Honor your need for rest instead of pushing through, and you protect the very energy that tomorrow's breakthrough requires to emerge",
  ...
  "🛡️ Walk away from a conversation that drains you today: the energy you preserve becomes the fuel for a creative surge that arrives by evening",
  ...
  "🛡️ Slow down when everything around you speeds up and you become the eye of the storm where safety, clarity, and right action converge naturally",
  ...
  "🛡️ Ground yourself this morning — feet on earth, breath in lungs, attention in body — and that grounding becomes armor against the day's uncertainties",
  ...
  "🐛 Stop comparing your path to anyone else's today and your unique trajectory reveals an advantage that copying someone else would have erased",
  "🔥 What you've been through was not punishment — it was preparation, and today brings the first clear evidence of what it was all for",
  ...
  "🌅 Begin the project you've been postponing with just five minutes of effort: those five minutes unlock a momentum that was waiting for your first step",
  ...
  "⭐ Your energy has the quality of dawn — something in you is rising, warming, and illuminating what was dark before no matter what time you read this",
