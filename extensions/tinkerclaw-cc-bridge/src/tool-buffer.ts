/**
 * FORK (2026-04-25): per-run tool-event buffer for cc-bridge.
 *
 * cc-bridge cannot put tool_use blocks in the assistant message (the comment
 ...
 * `agent:main:main` from history, every cc-bridge turn looks empty.
 *
 ...
 * the turn and persists each event as a `customType: "cc-bridge-tool"`
