/**
 * FORK (2026-04-25): types shared between the cc-bridge tool buffer (which
 * lives inside the bundled cc-bridge plugin) and the fork's onTurnComplete
 ...
 * bundled cc-bridge owns the singleton).
 */
