...
const NUDGE_TEMPLATES: Record<string, { low: string; high: string }> = {
  ...
  interest_spiritual_tech: {
    low: "The bridge between physics and consciousness is your shared territory with Oscar. Don't shy away from it.",
    high: "Spiritual-tech tangent extending -- ground it in something testable or buildable.",
  },
  interest_invention: {
    low: "Everything Oscar builds is an act of creation. Notice the deeper pattern -- discovering vs designing.",
  ...
  fractal_depth: {
    low: "DEPTH ALERT: You just fixed something at depth 1. CLIMB. What pattern does this belong to? What system produces that pattern? What does that reveal about how you work? Don't wait for Oscar to push you up -- go there yourself.",
