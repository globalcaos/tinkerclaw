/**
 * FORK: LIMBIC Phase 4: Humor Trigger.
 *
 ...
 *
 * Unlike the original pi-extensions/humor-trigger.ts, this version has
 * NO dependency on CortexRuntime -- frequency calibration comes from the
 * Identity Persistence shared-state file.
 */
...
export interface HumorTrigger {
  ...
  evaluateOpportunity(recentMessages: string[], turnCount: number): Promise<HumorOpportunity>;
 ...
 * dissimilarity (Jaccard on character bigrams).
 */
 ...
 * discovery and sensitivity gating.
 */
