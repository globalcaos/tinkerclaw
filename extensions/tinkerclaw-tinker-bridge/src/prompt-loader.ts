/**
 * FORK 2026-04-28 (bible §5.76): shared loader for tinker-bridge prompt
 ...
 *   3. Bundled default (extensions/tinkerclaw-tinker-bridge/prompts/<name>.md)
 *
...
export interface LoadPromptOptions {
  /** Plugin directory name (e.g. "tinkerclaw-tinker-bridge"). */
  plugin: string;
