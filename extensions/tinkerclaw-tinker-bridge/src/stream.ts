...
// FORK 2026-08-25 (the user: "the original chat just swallowed intermediate
...
//
// FORK 2026-08-28 (the user: "There seems to be a disconnect between what Jarvis
  ...
  return (model, context, options) => {
    ...
    const run = async () => {
      ...
      const emitEffort = (final: boolean, extra?: Record<string, unknown>) => {
        ...
        // FORK 2026-06-26 (eeg effort-truth, the user): the EEG debugs the automatic
