/**
 * FORK: prefrontal/persistence — Atomic JSON save/load for topology snapshots
 *
 * Provides `saveState()` and `loadState()` for persisting the Prefrontal topology
 ...
 *
 * Wired in by: imported from `./persistence.js` in `extensions/prefrontal/index.ts`
 */
