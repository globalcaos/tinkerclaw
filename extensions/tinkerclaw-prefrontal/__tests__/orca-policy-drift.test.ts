// FORK 2026-07-25 (the user): the ORCA panel's policy view is served from orca-policy.md, and
// the user's requirement was "the exact one that drives the real policy, so that there is never
