...
3. Read the latest paper md. Also cross-check the newest /home/globalcaos/.openclaw/workspace/memory/projects/papers/J-series-status-*.md (highest date) — its status column says whether this paper's notes were already addressed in a prior batch.
...
2. Generate each figure with NAPKIN (Oscar's chosen diagram tool — beautiful conceptual PNGs):
   bash /home/globalcaos/.openclaw/jarvis-workspace/.claude/skills/napkin-diagrams/scripts/napkin-generate.sh --file <section.md> ${BASE}/${t.folder}/images/<name>.png --variations 4 --style formal-balanced
