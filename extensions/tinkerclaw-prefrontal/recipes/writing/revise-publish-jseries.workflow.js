...
2. Generate each figure with NAPKIN (the user's chosen diagram tool — beautiful conceptual PNGs):
...
2b. COHESION PASS (the user's standing preference, 2026-08-02 — so all figures share one look): route each CONCEPTUAL figure Napkin produced through Nano Banana Pro edit mode, verbatim house-style prompt:
