...
summary: Read the user's register, mirror it in the reply, ask on genuine ambiguity, close with the dark decision-summary card
triggers:
  [
    answer,
    reply,
...
Produce a substantive reply that (1) speaks at the same register the user used, (2)
...
- Every substantive reply to the user (the default shape of an answer).
...
**Done when:** I can name the register the user pitched his prompt at.
...
- Answering hard-technical when the user spoke plain English (over-register).
