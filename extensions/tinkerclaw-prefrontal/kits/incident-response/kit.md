...
resolverHints:
  [
    {
      "match": "incident | breach | compromised | leak | security incident | unauthorized access",
      "load": ["kit.md"],
      "purpose": "Pick this kit for: incident, breach, compromised, leak, security incident, unauthorized access",
    },
  ]
---
