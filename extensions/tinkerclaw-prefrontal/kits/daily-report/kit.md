...
resolverHints:
  [
    {
      "match": "daily | status | standup | what happened | daily report | status update",
      "load": ["kit.md"],
      "purpose": "Pick this kit for: daily, status, standup, what happened, daily report, status update",
    },
  ]
---
