...
resolverHints:
  [
    {
      "match": "dependencies | outdated | upgrade | supply chain | dep audit | package audit",
      "load": ["kit.md"],
      "purpose": "Pick this kit for: dependencies, outdated, upgrade, supply chain, dep audit, package audit",
    },
  ]
---
