...
// ─── GitHub Copilot quota (the user 2026-07-30) ───
...
// ─── xAI quota (the user 2026-07-27: "figure out a way to find quota info for XAI") ───
...
export default function register(api: OpenClawPluginApi) {
  ...
  api.registerGatewayMethod("budget.usage", async ({ params, respond }) => {
    ...
    // one poll.
    //
    // FORK 2026-09-03 (the user: "I cannot see the budget graphs") — but it used to `await` that
    ...
    result.chatgpt = (() => {
      ...
      for (const [key, val] of Object.entries(chatgptData.models || {}) as [string, any][]) {
        ...
        models[key] = {
          ...
          // FORK 2026-07-31 (the user: "for sol-terra-luna, I am missing the reset
