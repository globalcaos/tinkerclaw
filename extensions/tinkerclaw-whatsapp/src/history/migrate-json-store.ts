/**
 * FORK: Migrate existing JSON store to SQLite
 * Run this once to import all messages from baileys_store_multi.json.
 *
 * Standalone CLI tool — not part of the plugin runtime. Parses the Baileys
 * JSON store format and batch-inserts contacts, chats, and messages into
 * the shared whatsapp-history SQLite database.
 *
 * Usage:
 *   bun extensions/tinkerclaw-whatsapp/src/history/migrate-json-store.ts [path-to-json]
 */
