 ...
 *
 * Wired in: barrel-exported from ./index.ts; used by history tool endpoints
 * to bulk-import WhatsApp .txt export files or entire directories of exports.
 */
