/**
 * FORK: tinkerclaw-whatsapp outbound send helpers.
 *
 * Copied from extensions/whatsapp/src/send.ts (Task 8). The runtime-api
 * import is redirected to the upstream plugin until Task 10 localizes
 * loadOutboundMediaFromUrl into this plugin.
 */
...
// TODO(task-10): localize loadOutboundMediaFromUrl from upstream runtime-api
import { loadOutboundMediaFromUrl } from "../../whatsapp/src/runtime-api.js";
import {
