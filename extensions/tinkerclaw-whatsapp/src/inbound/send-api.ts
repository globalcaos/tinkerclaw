/**
 * FORK: tinkerclaw-whatsapp outbound send API factory.
 *
 * Wraps a Baileys-compatible socket with high-level send helpers
 * (text, media, poll, reaction, composing) and records outbound
 * activity + sent IDs so echoes are filtered on the inbound side.
 */
...
import type { ActiveWebSendOptions } from "../../../whatsapp/src/active-listener.js";
