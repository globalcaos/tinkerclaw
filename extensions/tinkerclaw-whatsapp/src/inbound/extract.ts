/**
 * FORK: tinkerclaw-whatsapp message extraction utilities.
 *
 * Unwraps Baileys proto.IMessage wrappers and extracts text, media
 * placeholders, location data, mentioned JIDs, and reply context used
 * by the inbound pipeline. Identity + vCard helpers are imported from
 * the legacy extensions/whatsapp source tree for now.
 */
...
import { parseVcard } from "../../../whatsapp/src/vcard.js";
