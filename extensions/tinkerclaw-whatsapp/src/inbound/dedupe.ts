/**
 * FORK: tinkerclaw-whatsapp inbound dedupe cache.
 *
 * Prevents re-ingesting inbound messages already processed, and
 * tracks recently-sent outbound IDs so bot echoes can be ignored.
 */
