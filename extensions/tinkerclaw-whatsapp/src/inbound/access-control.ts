...
export async function checkInboundAccessControl(params: {
  ...
  // FORK 2026-05-03: unified owner-fromMe bypass. Per the owner-prefix
  // invariant, do not distinguish DM vs group at access-control. If the
  // inbound message comes from the linked account itself (the user typing on
  // their phone), allow
