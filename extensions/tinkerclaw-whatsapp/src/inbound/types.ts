/**
 * FORK: tinkerclaw-whatsapp inbound type definitions.
 *
 * Shared types for the inbound pipeline: close reasons and the
 * normalized WebInboundMessage shape passed to dispatch/hooks.
 */
