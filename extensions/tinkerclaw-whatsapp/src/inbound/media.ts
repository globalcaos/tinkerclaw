/**
 * FORK: tinkerclaw-whatsapp inbound media download helper.
 *
 * Resolves MIME types for inbound Baileys messages and downloads
 * media buffers for the inbound pipeline. Falls back to WhatsApp's
 * default formats when Baileys omits the MIME.
 */
import type { proto, WAMessage } from "@whiskeysockets/baileys";
import { logVerbose } from "openclaw/plugin-sdk/runtime-env";
import type { createWaSocket } from "../../../whatsapp/src/session.js";
