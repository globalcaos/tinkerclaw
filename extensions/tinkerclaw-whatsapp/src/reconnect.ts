/**
 * FORK: tinkerclaw-whatsapp reconnect policy helpers.
 *
 * Copied from extensions/whatsapp/src/reconnect.ts (Task 8). Provides
 * the backoff policy and heartbeat resolver used by the auto-reply
 * monitor.
 */
