/**
 * FORK: WhatsApp History Tool
 *
 * Allows agents to search and query WhatsApp message history stored in SQLite.
 * Supports full-text search, stats, and import of WhatsApp chat exports.
 */
...
- Find what Alice said: { "action": "search", "sender": "Alice", "limit": 20 }
