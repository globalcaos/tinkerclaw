/**
 * FORK: Behavioral Probes (self-contained copy for extension).
 *
 ...
 *
 * Adapted from src/memory/cortex/behavioral-probes.ts.
 * Removed EventStore dependency -- store parameter is optional and typed as
...
/**
 * Minimal event store interface for probe result persistence.
 * Avoids importing the full ENGRAM EventStore.
 */
export interface ProbeEventStore {
...
/**
 * Run all scheduled probes for a given turn.
 * Results are optionally stored in the event store if provided.
 */
