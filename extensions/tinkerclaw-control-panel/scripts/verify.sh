#!/usr/bin/env bash
# FORK: tinkerclaw-control-panel — end-to-end verify suite.
#
...
#
# Usage:
#   bash extensions/tinkerclaw-control-panel/scripts/verify.sh
#
# Exit codes:
...
echo "════════════════════════════════════════════════════════════════════"
echo "FLOWS-F1-VERIFY — tinkerclaw-control-panel               run=$RUN_ID"
echo "════════════════════════════════════════════════════════════════════"
