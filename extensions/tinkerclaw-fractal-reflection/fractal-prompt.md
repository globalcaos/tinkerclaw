...
**Named host is a catalog lookup, not a search fallback (2026-09-03).** If the prompt names a
site, a host, a format, or says a skill already exists — YouTube, Gmail, Amazon, a URL — the
inventory check is not optional. The user had to say "Did you forget we have a youtube skill?" on
2026-04-23 and again on 2026-09-03. That is two days of the same gap. A miss here is a skipped
