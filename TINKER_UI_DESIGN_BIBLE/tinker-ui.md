...
Files with at least one `// FORK YYYY-MM-DD:` anchor — sorted by most-recent edit. Total anchors: **75** across **3** files.

| File                            | Anchors | First      | Last       |
| ------------------------------- | ------- | ---------- | ---------- |
| `src/app.ts`                    | 65      | 2026-04-17 | 2026-05-11 |
| `src/styles/base.css`           | 8       | 2026-04-17 | 2026-05-11 |
