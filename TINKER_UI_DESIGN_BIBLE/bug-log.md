...
- **File:** `src/agents/pi-embedded-runner/run/attempt.ts` (prompt-submission branch ~L2742-2862: `preDeliberationSystemPromptText` snapshot + `turnSystemPromptText` local + turn-local re-apply + `finally` restore).
