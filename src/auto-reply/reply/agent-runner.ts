...
import { queueEmbeddedPiMessage } from "../../agents/embedded-agent-runner/runs.js";
...
export async function runReplyAgent(params: {
  ...
  if (shouldSteer && isActive) {
    ...
    //
    // MEASURED (the user, 2026-08-28): with steer-backlog on webchat, a prompt typed mid-turn is
