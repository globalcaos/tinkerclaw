...
export function handleCompactionEnd(
  ...
  // FORK 2026-07-27 (the user: "instrument the compaction predicate") — gate "pi-auto".
  //
  ...
  // FORK 2026-08-29 (the user: the CONTEXT WINDOW panel's "tokens saved by eviction"). pi hands us
