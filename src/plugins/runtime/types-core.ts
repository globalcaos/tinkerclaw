...
export type PluginRuntimeCore = {
  ...
  agent: {
    ...
    runEmbeddedAgent: import("../../agents/embedded-agent-runtime.types.js").RunEmbeddedAgentFn;
    runEmbeddedPiAgent: import("../../agents/embedded-agent-runtime.types.js").RunEmbeddedPiAgentFn;
