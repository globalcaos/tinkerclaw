...
function loadPersonaState(): import("../memory/cortex/persona-state.js").PersonaState {
	...
	if (existsSync(stateFile)) {
		try {
			...
			return _personaModule.createDefaultPersonaState("JarvisOne", "AI assistant and extension of Oscar");
		}
	}
	const state = _personaModule.createDefaultPersonaState("JarvisOne", "AI assistant and extension of Oscar");
