// ============================================================
// src/amygdala/types.ts
// All TypeScript interfaces for the AMYGDALA system
// ============================================================
...
export interface PrudenceOutput {
  ...
  confidence: number;
  /** How ambiguous is the situation? Sigmoid ∈ [0,1] */
  ambiguity_score: number;
}

/** Output from a single Personality network */
export interface PersonalityOutput {
  /** Continuous behavioural modulation vector ∈ R^64 */
...
export interface AmygdalaConfig {
  ...
  trust: {
    /** Prudence trust coefficient α_P ∈ [0, 1] */
    alpha_prudence: number;
    /** Personality trust coefficient α_I ∈ [0, 1] */
  ...
  conformal: {
    /** Significance level ε (default 0.05 for 95% coverage) */
    epsilon: number;
