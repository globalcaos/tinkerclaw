// ============================================================
// src/amygdala/__tests__/embedding.test.ts
// P0.2 — Embedding Pipeline Tests
// ============================================================
//
...
//
// Generate them first:
//   python src/amygdala/export_encoder.py
//
...
import os from 'os';
import { EmbeddingWindow, EmbeddingPipeline, cosineSimilarity } from '../embedding';
