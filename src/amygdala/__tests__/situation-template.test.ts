...
import type { AmygdalaConfig, EmotionalSignal } from '../types.js';
import {
  buildSituation,
  serializeSituation,
  classifyActionType,
...
describe('getLastHumanReference', () => {
  ...
  it('should return hours proportional to how far back it was mentioned', () => {
    ...
    const transcripts = [
      'other message 1', 'other message 2', 'other message 3',
      'other message 4', 'other message 5', 'other message 6',
      'please fix config.yaml', // index 6
      'other message 7', 'other message 8', 'other message 9',
      'other message 10', 'latest message', // index 11
    ];
