...
function rejectWebchatSessionMutation(params: {
  ...
  // FORK 2026-08-28 (the user: manual evict/compact buttons in the CONTEXT WINDOW panel) — allow
...
// FORK 2026-08-28 (the user: the CONTEXT WINDOW panel's manual "evict" button) — transcript-aware
...
export const sessionsHandlers: GatewayRequestHandlers = {
  ...
  "sessions.compact": async ({ req, params, respond, context, client, isWebchatConnect }) => {
    ...
    if (maxLines === undefined) {
      ...
      // FORK 2026-09-07 (the user: "I clicked compact, it churned for a while, and nothing") — the
