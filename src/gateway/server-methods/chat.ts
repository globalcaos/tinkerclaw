...
// FORK 2026-08-25 (the user: "the intermediate thinking gets deleted in the chat") — a message goes
...
/**
 * FORK 2026-08-20 (the user: Stop Grok, it spins again). `chat.abort` used to
