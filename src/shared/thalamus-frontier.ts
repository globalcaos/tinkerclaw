...
// (the yellow envelope) and by the reply-path Auto router, so the line the user sees and
...
//      €/TASK axis — the user 2026-09-02: "make sure to use the graph in €/task to make
