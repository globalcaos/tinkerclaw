// FORK 2026-07-28 (the user: "implement the liveness invariant") — the INSTRUMENT LIVENESS
...
//
// FORK 2026-08-03 (the user: "it works; nobody can read it") — THE ALARM'S OWN SIGNAL-TO-NOISE.
