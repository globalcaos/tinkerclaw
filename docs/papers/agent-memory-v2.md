...
class PersonaState:
    ...
    # Reference Samples (for E_phi calibration)
...
class HumorCalibration:
    ...
    sensitivity_threshold: float        # LIMBIC sensitivity gate tau
...
|---|---|---|---|---|---|
| A1: Full CORTEX | YES | YES | YES | YES | YES |
| A2: No IPC | NO | YES | YES | YES | YES |
| A3: No Drift Detection | YES | NO | — | — | — |
| A4: User Signal Only | YES | YES | YES | NO | NO |
| A5: Probe Signal Only | YES | YES | NO | YES | YES |
...
| Metric | Baseline | CORTEX | Delta |
|---|---|---|---|
| Drift Detection Latency | N/A (no detection) | 2.4 turns (sigma = 0.8) | — |
| Recovery Rate (within 5 turns) | 15% | 92% | +77 pp |
| Persona Consistency $C$ (post-perturbation) | 0.45 (sigma = 0.12) | 0.88 (sigma = 0.06) | +0.43 |
...
def ipc_compact(
    ...
    # Compute E_phi to verify persona preservation
...
class PersonaFeatures:
    """Operationally defined persona feature vector E_phi."""
