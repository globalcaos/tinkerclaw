...
Over time, the agent learns: "the user laughs at domain-transfer humor about work (confidence: 0.85) but not at self-deprecating AI jokes (confidence: 0.3)." This is **humor taste profiling** — the comedic equivalent of a recommendation system.
...
Over time, this creates a **humor reinforcement model** — not through gradient descent, but through Bayesian updating of `humor_confidence` per audience-context pair. The agent effectively learns: "jokes about bureaucracy land with the user at 0.85 confidence, but self-deprecating AI humor lands at only 0.3."
